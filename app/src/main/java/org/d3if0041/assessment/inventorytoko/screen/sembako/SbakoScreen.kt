...
import org.d3if0041.assessment.inventorytoko.database.CatatanDb
import org.d3if0041.assessment.inventorytoko.ui.theme.InventoryTokoTheme
import org.d3if0041.assessment.inventorytoko.util.SembakoModelFactory

const val KEY_NAMA_SEMBAKO= "nama"
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun SbakoScreen(navController: NavHostController, id: String? = null) {
    val context = LocalContext.current
    val db = CatatanDb.getInstance(context)
    val factory = SembakoModelFactory(db.dao)
    val viewModel: SbakoViewModel = viewModel(factory = factory)
            ...
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = {
                        ...
                        if (selectedImageUri == null) {
                            ...
                            try {
                                ...
                                Log.e("SbakoScreen", "Error updating or inserting", e)
                                Toast.makeText(
                                    context,
                    ...
                    IconButton(onClick = {
                        ...
                        shareDataSembako(context, message, selectedImageUri)
                    }) {
                        Icon(
                    ...
                    if (id != null) {
                        DeleteActionSembako {showDialog = true}
                        SembakoAlertDialog(
...
@Composable
fun DeleteActionSembako(delete: () -> Unit) {
...
private fun shareDataSembako(context: Context, message: String, imageUri: Uri?) {
...
@Composable
fun SbakoScreenPreview() {
    InventoryTokoTheme {
        SbakoScreen(rememberNavController())
    }
}