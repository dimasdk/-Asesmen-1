...
const val KEY_NAMA_MAKANAN= "nama"
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun FoodScreen(navController: NavHostController, id: String? = null) {
    ...
    LaunchedEffect(true) {
        ...
        val data = viewModel.getMakanan(id) ?: return@LaunchedEffect
        if (data != null) {
            nama = data.nama
        }
        if (data != null) {
            ...
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = {
                        ...
                        if (selectedImageUri == null) {
                            ...
                            try {
                                ...
                                Log.e("FoodScreen", "Error updating or inserting", e)
                                Toast.makeText(
                                    context,
                    ...
                    IconButton(onClick = {
                        ...
                        shareDataMakanan(context, message, selectedImageUri)
                    }) {
                        Icon(
                    ...
                    if (id != null) {
                        DeleteActionMakanan { showDialog = true }
                        MakananAlertDialog(
...
@Composable
fun DeleteActionMakanan(delete: () -> Unit) {
...
private fun shareDataMakanan(context: Context, message: String, imageUri: Uri?) {
