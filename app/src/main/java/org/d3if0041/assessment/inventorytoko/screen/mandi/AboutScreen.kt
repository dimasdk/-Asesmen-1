...
import org.d3if0041.assessment.inventorytoko.database.MandiDb
import org.d3if0041.assessment.inventorytoko.ui.theme.InventoryTokoTheme
import org.d3if0041.assessment.inventorytoko.util.ViewModelFactory

const val KEY_NAMA_MANDI= "nama"
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun AboutScreen(navController: NavHostController, id: String? = null) {
    ...
    LaunchedEffect(true) {
        ...
        val data = viewModel.getMandi(id) ?: return@LaunchedEffect
        if (data != null) {
            nama = data.nama
        }
        if (data != null) {
                    ...
                    IconButton(onClick = {
                        ...
                        if (selectedImageUri == null) {
                            ...
                            try {
                                ...
                                Log.e("AboutScreen", "Error updating or inserting", e)
                                Toast.makeText(
                                    context,
